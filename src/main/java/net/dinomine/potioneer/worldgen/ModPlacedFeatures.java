...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> STAR_FLOWER_PLACED_KEY = registerKey("star_flower_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, STAR_FLOWER_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.STAR_FLOWER_CONFIGURED_KEY),
                List.of(
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(Potioneer.MOD_ID, name));
    }
