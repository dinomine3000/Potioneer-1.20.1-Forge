...
public class PotioneerClientConfig {
    ...
    static{
        ...
        ORB_OFFSET = BUILDER.comment("Offset of the orb from its left margin, between 0-1" +
                        "\nThe orb will be this percantage of half your screen width away from the left margin (left or center)" +
                        "\nie.: percent of 0 means it will be touching the game border or center, 1 will mean its smack down the middle or completely to the right")
