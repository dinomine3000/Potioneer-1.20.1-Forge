...
public class WindShearRenderer extends EntityRenderer<WindShearProjectile> {

    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Potioneer.MOD_ID, "textures/entity/wind_shear.png");

    public WindShearRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    public void render(WindShearProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(WindShearProjectile windShearProjectile) {
