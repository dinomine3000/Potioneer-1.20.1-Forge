...
public class PaperDaggerRenderer extends EntityRenderer<PaperDaggerProjectile> {

    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(Potioneer.MOD_ID, "textures/entity/paper_dagger.png");

    public PaperDaggerRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }

    public void render(PaperDaggerProjectile pEntity, float pEntityYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
        pPoseStack.pushPose();
        ...
        Matrix4f $$7 = $$6.pose();
        Matrix3f $$8 = $$6.normal();
        VertexConsumer $$9 = pBuffer.getBuffer(RenderType.entityCutoutNoCull(TEXTURE_LOCATION));
    ...
    @Override
    public ResourceLocation getTextureLocation(PaperDaggerProjectile windShearProjectile) {
