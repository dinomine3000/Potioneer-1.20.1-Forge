...
public abstract class SplitPage extends Page {
    ...
    protected SplitPage setDrawTop(boolean drawTop){
        this.drawTop = drawTop;
        return this;
    }

    protected SplitPage setDrawBottom(boolean drawBottom){
    ...
    public void draw(GuiGraphics pGuiGraphics, ResourceLocation texture, int leftPos, int topPos, int imageWidth, int imageHeight, int textureWidth, int textureHeight) {
        ...
        if(drawBottom) drawScaledText(pGuiGraphics, this.bottomText, leftPos + 5, topPos + 100 - yOffset, 0, 110);
