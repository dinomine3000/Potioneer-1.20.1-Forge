...
public class PageRegistry {
    ...
    public static Page LADY_FATE_1 = register(i++, () -> new TextPage(Page.Chapter.KNOWN_DEITIES, Component.translatable("page.potioneer.lady_fate"), Component.translatable("contents.potioneer.lady_fate", WheelOfFortuneResponse.PRAYER)).withScale(1));
    public static Page LADY_FATE_2 = register(i++, () -> new TextPage(Page.Chapter.KNOWN_DEITIES, "lady_fate_2"));
    public static Page KING_OF_HEROES_1 = register(i++, () -> new TextPage(Page.Chapter.KNOWN_DEITIES, Component.translatable("page.potioneer.king_of_heroes"), Component.translatable("contents.potioneer.king_of_heroes", TyrantResponse.PRAYER)).withScale(1));
    public static Page KING_OF_HEROES_2 = register(i++, () -> new TextPage(Page.Chapter.KNOWN_DEITIES, "king_of_heroes_2"));
    public static Page CHARM_TEMP_LUCK = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "luck"));
    public static Page CHARM_INSTANT_LUCK = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "instant_luck"));
    public static Page CHARM_TEMP_BAD_LUCK = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "bad_luck"));
    public static Page CHARM_INSTANT_BAD_LUCK = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "instant_bad_luck"));
    public static Page CHARM_CHAOTIC_LUCK = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "chaotic_luck"));
    public static Page CHARM_LUCK = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "luck_effect"));
    public static Page CHARM_COOLDOWN = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "cooldown"));
    public static Page CHARM_SPEED = register(i++, () -> new RitualRecipePage(Page.Chapter.CHARMS, "velocity"));
