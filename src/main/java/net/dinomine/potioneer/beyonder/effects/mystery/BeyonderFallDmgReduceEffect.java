...
public class BeyonderFallDmgReduceEffect extends BeyonderEffect {
    ...
    public BeyonderFallDmgReduceEffect(){
        this(0, 0f, 0, false, BeyonderEffects.EFFECT.MYSTERY_FALL);
    }

    public BeyonderFallDmgReduceEffect(int level, float cost, int time, boolean active, BeyonderEffects.EFFECT id){
        super(level, cost, time, active, id);
        this.name = "Fall Damage Reduce";
    }
