...
public class PotioneerDamage {
    ...
    public static final ResourceKey<DamageType> THEFT = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(Potioneer.MOD_ID, "theft"));
...
//    public static final ResourceKey<DamageType> ANNIHILATION = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(Potioneer.MOD_ID, "annihilation"));
    ...
    public static DamageSource theft(ServerLevel level, LivingEntity attacker) {
        return getSource(level, THEFT, attacker);
    }
    ...
    public static DamageSource air_bullet(ServerLevel level, LivingEntity attacker){
        return getSource(level, AIR_BULLET, attacker);
    }
