    ...
    public class CloneAbility extends Ability {
        ...
        protected boolean primary(BeyonderCapability cap, LivingEntity target) {
            ...
            IllusionEffect eff = (IllusionEffect) BeyonderEffects.MYSTERY_ILLUSION.createInstance(getSequenceLevel(), 0, -1, true);
            eff.setClone(clone);
        ...
        protected boolean secondary(BeyonderCapability cap, LivingEntity target) {
            ...
            cap.getEffectsManager().addOrReplaceEffect(BeyonderEffects.MYSTERY_INVISIBLE.createInstance(getSequenceLevel(), 0, 20*15, true), cap, target);
            return true;
        }
    }
